...
$array =  array("intrebare"=>"DE CE ÎȚI DAI JOS TRICOUL LA UN PARTY?","raspuns1"=>"SUNT BEAT", "raspuns2"=>"SĂ-MI ARĂT MUȘCHII", "raspuns3"=>"INTRĂ PIESA AIA", "raspuns4"=>"DE NERVI", "raspuns5"=>"AM VĂRSAT CEVA PE MINE", "raspuns6"=>"MI-AM RUPT TRICOUL","punctaj1"=>"47","punctaj2"=>"15","punctaj3"=>"14","punctaj4"=>"10","punctaj5"=>"8","punctaj6"=>"6","prev"=>"intrebare12.php", "next"=>"intrebare14.php");
