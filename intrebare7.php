...
$array =  array("intrebare"=>"CE NU LIPSEȘTE DE LA O PETRECERE DIN CĂMIN, ÎN AFARĂ DE PRIETENI?","raspuns1"=>"MUZICĂ", "raspuns2"=>"BĂUTURĂ", "raspuns3"=>"NARGHILEA/ȚIGĂRI", "raspuns4"=>"JOCURI", "raspuns5"=>"RECLAMAȚII", "raspuns6"=>"FETE","punctaj1"=>"42","punctaj2"=>"30","punctaj3"=>"14","punctaj4"=>"6","punctaj5"=>"5","punctaj6"=>"3","prev"=>"intrebare6.php", "next"=>"intrebare8.php");
  ...
  <div class="back" style="border-radius: 100px;">
   ...
   <div style="text-align:center;  width: 700px; height:80px;
  align-items: center;
