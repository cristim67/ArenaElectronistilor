...
<html>
<head>
	<title>Ce spun electronistii?</title>
...
margin-bottom: 1rem;
 text-align: center;">
  ...
  <div class="flipper-timer" style="zoom:3;margin-top:3rem; background-color:#fff; border-radius: 100px;">
  <div class="front" style="background-color:#fff; color:black;border-radius: 100px;">
    <h1 style="zoom:0.8">30</h1>
  </div>
  <div class="back" style="border-radius: 100px;">
	...
	<div class="container" style=" text-align: center; margin-top:10.4rem;" >
	...
	function next(){
	   ...
	   location.href="rundarapidaafis1.php";
...
document.addEventListener('keydown', function(event) {
  if (event.key === '1') {
    var card = document.querySelector('[data-number="40"]');
    card.classList.toggle('clicked');
    playGood()
    
  } else if (event.key === '2') {
    var card = document.querySelector('[data-number="31"]');
    card.classList.toggle('clicked');
    playGood()
  }
  else if(event.key==='3'){
      var card=document.querySelector('[data-number="21"]')
        card.classList.toggle('clicked');
        playGood()
  }
  else if(event.key==='4'){
      var card=document.querySelector('[data-number="2"]')
        card.classList.toggle('clicked');
        playGood()
  }
    else if(event.key==='5'){
      var card=document.querySelector('[data-number="3"]')
        card.classList.toggle('clicked');
        playGood()
  }
    else if(event.key==='6'){
      var card=document.querySelector('[data-number="1"]')
        card.classList.toggle('clicked');
        playGood()
  }
});
