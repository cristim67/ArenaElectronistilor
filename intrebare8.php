...
$array =  array("intrebare"=>"CE TE ÎNTREABĂ PĂRINȚII CÂND TE SUNĂ?","raspuns1"=>"DACĂ AI MÂNCAT", "raspuns2"=>"CUM STAI CU FACULTATEA", "raspuns3"=>"DACĂ MAI AI BANI", "raspuns4"=>"DACĂ ÎȚI TRIMIT PACHET", "raspuns5"=>"CÂND VII ACASĂ", "raspuns6"=>"DE CE NU AI MAI SUNAT","punctaj1"=>"35","punctaj2"=>"28","punctaj3"=>"15","punctaj4"=>"12","punctaj5"=>"7","punctaj6"=>"3","prev"=>"intrebare7.php", "next"=>"intrebare9.php");
...
background-color:#fff;box-shadow: rgba(60, 64, 67, 0.3) 0px 1px 2px 0px, rgba(60, 64, 67, 0.15) 0px 2px 6px 2px;   border-radius: 10px;margin:auto; ">
  ...
  <h1 style="text-align:center;margin-top:0.2rem;">~ <?php echo$array["punctaj4"]; ?> ~ </h1>
