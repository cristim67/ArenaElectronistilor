...
$array =  array("intrebare"=>"CE BĂUTURĂ SE BEA LA UN PARTY ÎN CĂMIN?","raspuns1"=>"BERE", "raspuns2"=>"VIN", "raspuns3"=>"GIN", "raspuns4"=>"ROM", "raspuns5"=>"WHISKEY", "raspuns6"=>"VODKA","punctaj1"=>"45","punctaj2"=>"29","punctaj3"=>"10","punctaj4"=>"8","punctaj5"=>"5","punctaj6"=>"3","prev"=>"intrebare2.php", "next"=>"intrebare4.php");
