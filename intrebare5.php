...
$array =  array("intrebare"=>"CE FACI CÂND NU AI APĂ CALDĂ LA CĂMIN?","raspuns1"=>"ÎNCĂLZEȘTI APA", "raspuns2"=>"DUȘ RECE", "raspuns3"=>"DUȘ LA SALĂ", "raspuns4"=>"MERGI LA UN PRIETEN ", "raspuns5"=>"DAI MESAJE PE GRUPUL CĂMINULUI", "raspuns6"=>"STAI CU OCHII PE RADET " ,"punctaj1"=>"44","punctaj2"=>"20","punctaj3"=>"16","punctaj4"=>"9","punctaj5"=>"6","punctaj6"=>"5","prev"=>"intrebare4.php", "next"=>"intrebare6.php"); 
  ...
  <div class="back" style="border-radius: 100px;">
   ...
   <div style="text-align:center;  width: 500px; height:80px;
  align-items: center;
...
<div class="card" data-number="<?php echo$array["punctaj5"]; ?>">
  <div class="flipper" >
    ...
    <div class="back">
      <h1 style="text-align:center;margin-top:1rem;"><?php echo$array["raspuns5"]; ?></h1>
      
  <h1 style="text-align:center;margin-top:0.2rem;">~ <?php echo$array["punctaj5"]; ?> ~ </h1>
    </div>
  </div>
</div>
<div class="card" data-number="<?php echo$array["punctaj6"]; ?>">
  <div class="flipper" >
    ...
    <div class="back">
      <h1 style="text-align:center;margin-top:1rem;"><?php echo$array["raspuns6"]; ?></h1>
      
  <h1 style="text-align:center;margin-top:0.2rem;">~ <?php echo$array["punctaj6"]; ?> ~ </h1>
    </div>
  </div>  
</div>
