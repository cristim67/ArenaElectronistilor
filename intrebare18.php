...
$array =  array("intrebare"=>"CE SE JOACĂ STUDENȚII CÂND SE STRÂNG ÎN CAMERA DE CĂMIN?","raspuns1"=>"ACTIVITY", "raspuns2"=>"ALIAS", "raspuns3"=>"CATAN", "raspuns4"=>"MONOPOLY", "raspuns5"=>"POKER", "raspuns6"=>"RUMMY","punctaj1"=>"35","punctaj2"=>"25","punctaj3"=>"17","punctaj4"=>"13","punctaj5"=>"7","punctaj6"=>"3","prev"=>"intrebare17.php", "next"=>"clasament.php");
