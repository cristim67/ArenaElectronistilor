...
$array =  array("intrebare"=>"GÂNDURI PE CARE LE ARE ORICE STUDENT ÎN SESIUNE","raspuns1"=>"CE CAUT AICI", "raspuns2"=>"VREAU DOAR 45/50P", "raspuns3"=>"AVEM PRAG", "raspuns4"=>"CÂT ÎMI MAI TREBUIE", "raspuns5"=>"CUM SĂ COPIEZE", "raspuns6"=>"NE VEDEM ÎN TOAMNĂ","punctaj1"=>"25","punctaj2"=>"22","punctaj3"=>"17","punctaj4"=>"14","punctaj5"=>"12","punctaj6"=>"10","prev"=>"intrebare11.php", "next"=>"intrebare13.php");
