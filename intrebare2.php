...
$array =  array("intrebare"=>"NUMEȘTE UN COMPLEX DE CĂMINE STUDENȚEȘTI DIN BUCUREȘTI","raspuns1"=>"LEU", "raspuns2"=>"REGIE", "raspuns3"=>"GROZĂVEȘTI", "raspuns4"=>"BELVEDERE", "raspuns5"=>"MOXA", "raspuns6"=>"ARCCA","punctaj1"=>"47","punctaj2"=>"25","punctaj3"=>"10","punctaj4"=>"7","punctaj5"=>"6","punctaj6"=>"5","prev"=>"index.php", "next"=>"intrebare3.php");
