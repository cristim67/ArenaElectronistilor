 ...
 text-align: center;">
     ...
     <div style="position:absolute; background-color:#fff;box-shadow: rgba(60, 64, 67, 0.3) 0px 1px 2px 0px, rgba(60, 64, 67, 0.15) 0px 2px 6px 2px;   border-radius: 10px;margin-left:2rem; zoom:0.80;">
       <div style="text-align:left;margin-left:3rem; margin-right:3rem;margin-top:1rem; margin-bottom:2rem; "> <h1>Clasament   </div>
        ...
        $i=1;
$array =  array("intrebare"=>"CE PRIMEȘTE UN STUDENT ÎN PACHETUL CU M NCARE DE LA PĂRINȚII SĂI?","raspuns1"=>"ZACUSCĂ", "raspuns2"=>"ȘNIȚELE", "raspuns3"=>"SARMALE", "raspuns4"=>"CHIFTELE", "raspuns5"=>"FRIPTURĂ", "raspuns6"=>"DULCIURI","punctaj1"=>"35","punctaj2"=>"25","punctaj3"=>"15","punctaj4"=>"10","punctaj5"=>"8","punctaj6"=>"7","prev"=>"intrebare13.php", "next"=>"intrebare15.php");
