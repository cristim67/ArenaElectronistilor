...
margin-bottom: 10rem;
 text-align: center; ">
     ...
     <div style="position:absolute; background-color:#fff;box-shadow: rgba(60, 64, 67, 0.3) 0px 1px 2px 0px, rgba(60, 64, 67, 0.15) 0px 2px 6px 2px;   border-radius: 10px;margin-top:-5rem;  position: absolute;
  right: 850px;
  width: 500px;
  padding: 10px;zoom:0.80; ">
       <div style="text-align:center;margin:0;margin-right:3rem;margin-top:1rem; margin-bottom:2rem; "> <h1>Clasament</div>
 ...
 $array =  array("intrebare"=>"CE FACI ÎNAINTE DE UN EXAMEN?","raspuns1"=>"NOAPTE ALBĂ/ÎNVEȚI", "raspuns2"=>"COPIUTE", "raspuns3"=>"TE ROGI", "raspuns4"=>"DORMI", "raspuns5"=>"PETRECI", "raspuns6"=>"CAUȚI CASCĂ","punctaj1"=>"31","punctaj2"=>"25","punctaj3"=>"17","punctaj4"=>"15","punctaj5"=>"7","punctaj6"=>"5","prev"=>"clasament.php", "next"=>"clasament.php");
