...
$array =  array("intrebare"=>"NUMEȘTE UN EVENIMENT ORGANIZAT DE DEPARTAMENTUL ÎNVĂȚĂM NT","raspuns1"=>"SIMULAREA", "raspuns2"=>"TREASURE HUNT", "raspuns3"=>"BOARDGAMES CARITABIL", "raspuns4"=>"CCG", "raspuns5"=>"PREZENTAREA SPECIALIZĂRILOR", "raspuns6"=>"DISCOVER YOUR FUTURE","punctaj1"=>"33","punctaj2"=>"23","punctaj3"=>"18","punctaj4"=>"13","punctaj5"=>"8","punctaj6"=>"5","prev"=>"intrebare14.php", "next"=>"intrebare16.php");
  ...
  <div class="back" style="border-radius: 100px;">
   ...
   <div style="text-align:center;  width: 650px; height:80px;
  align-items: center;
...
background-color:#fff;box-shadow: rgba(60, 64, 67, 0.3) 0px 1px 2px 0px, rgba(60, 64, 67, 0.15) 0px 2px 6px 2px;   border-radius: 10px;margin:auto; ">
  ...
  <div class="card" data-number="<?php echo$array["punctaj3"]; ?>">
    <div class="flipper" >
      ...
      <div class="back">
        <h1 style="text-align:center;margin-top:1.5rem;zoom:0.9"><?php echo$array["raspuns3"]; ?></h1>
...
<div class="card" data-number="<?php echo$array["punctaj5"]; ?>">
  <div class="flipper" >
    ...
    <div class="back">
      <h1 style="text-align:center;margin-top:1.5rem;zoom:0.75"><?php echo$array["raspuns5"]; ?></h1>
...
<div class="card" data-number="<?php echo$array["punctaj6"]; ?>">
  <div class="flipper" >
    ...
    <div class="back">
      <h1 style="text-align:center;margin-top:1.5rem;zoom:0.9;"><?php echo$array["raspuns6"]; ?></h1>
