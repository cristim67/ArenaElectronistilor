 ...
 text-align: center;">
     ...
     <div style="position:absolute; background-color:#fff;box-shadow: rgba(60, 64, 67, 0.3) 0px 1px 2px 0px, rgba(60, 64, 67, 0.15) 0px 2px 6px 2px;   border-radius: 10px;margin-left:2rem; zoom:0.80;">
       <div style="text-align:left;margin-left:3rem; margin-right:3rem;margin-top:1rem; margin-bottom:2rem; "> <h1>Clasament   </div>
        ...
        $i=1;
$array =  array("intrebare"=>"CARE ESTE CEA MAI MARE MINCIUNĂ PE CARE ȘI-O SPUN STUDENȚII?","raspuns1"=>"DE MÂINE MĂ APUC DE ÎNVĂȚAT/ ÎNVĂȚ DIN TIMP", "raspuns2"=>"MĂ DUC LA CURS", "raspuns3"=>"MÂINE MĂ TREZESC DEVREME", "raspuns4"=>"NU MAI BEAU", "raspuns5"=>"ANUL ĂSTA IAU BURSĂ", "raspuns6"=>"DE MÂINE MERG LA SALĂ","punctaj1"=>"50","punctaj2"=>"24","punctaj3"=>"13","punctaj4"=>"8","punctaj5"=>"3","punctaj6"=>"2","prev"=>"intrebare5.php", "next"=>"intrebare7.php");
...
background-color:#fff;box-shadow: rgba(60, 64, 67, 0.3) 0px 1px 2px 0px, rgba(60, 64, 67, 0.15) 0px 2px 6px 2px;   border-radius: 10px;margin:auto; ">
	...
	<div class="container" style=" text-align: center; margin-top:10.4rem; margin-left:4rem;" >
		...
		<div class="card" data-number="<?php echo$array["punctaj1"]; ?>">
          ...
          <h1 style="text-align:center;margin-top:0.1rem;zoom:0.8;"><?php echo$array["raspuns1"]; ?> </h1>
  ...
  <div class="card" data-number="<?php echo$array["punctaj3"]; ?>">
    <div class="flipper" >
      ...
      <div class="back">
        <h1 style="text-align:center;margin-top:0.5rem;"><?php echo$array["raspuns3"]; ?></h1>
  ...
  <div class="card" data-number="<?php echo$array["punctaj4"]; ?>">
    <div class="flipper" >
      ...
      <div class="back">
        ...
        <h1 style="text-align:center;margin-top:1.5rem;"><?php echo$array["raspuns4"]; ?></h1>
...
<div class="card" data-number="<?php echo$array["punctaj5"]; ?>">
  <div class="flipper" >
    ...
    <div class="back">
      <h1 style="text-align:center;margin-top:1.5rem;"><?php echo$array["raspuns5"]; ?></h1>
...
<div class="card" data-number="<?php echo$array["punctaj6"]; ?>">
  <div class="flipper" >
    ...
    <div class="back">
      <h1 style="text-align:center;margin-top:1.5rem;"><?php echo$array["raspuns6"]; ?></h1>
      
  <h1 style="text-align:center;margin-top:0.1rem;">~ <?php echo$array["punctaj6"]; ?> ~ </h1>
    </div>
  </div>  
</div>
