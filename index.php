...
margin-bottom: 1rem;
 ...
 $array =  array("intrebare"=>"CE FACI ÎNAINTE DE UN EXAMEN?","raspuns1"=>"BERE", "raspuns2"=>"BERE", "raspuns3"=>"BERE", "raspuns4"=>"BERE", "raspuns5"=>"BERE", "raspuns6"=>"BERE","punctaj1"=>"31","punctaj2"=>"25","punctaj3"=>"17","punctaj4"=>"15","punctaj5"=>"7","punctaj6"=>"5","prev"=>"index.php", "next"=>"intrebare2.php");
