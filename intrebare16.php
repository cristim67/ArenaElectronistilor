...
$array =  array("intrebare"=>"CE ÎȘI CUMPĂRĂ UN STUDENT DE LA LUCA?","raspuns1"=>"TRADIȚIONAL", "raspuns2"=>"COVRIGI", "raspuns3"=>"PIZZA", "raspuns4"=>"ȘTRUDEL", "raspuns5"=>"SENDVIȘ", "raspuns6"=>"MERDENEA","punctaj1"=>"36","punctaj2"=>"24","punctaj3"=>"20","punctaj4"=>"13","punctaj5"=>"5","punctaj6"=>"2","prev"=>"intrebare15.php", "next"=>"intrebare17.php");
