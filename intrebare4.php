...
$array =  array("intrebare"=>"CE ELECTROCASNICE ÎȘI ADUCE UN STUDENT ÎN CAMERA DE CĂMIN?","raspuns1"=>"FRIGIDER", "raspuns2"=>"CUPTOR CU MICROUNDE", "raspuns3"=>"PLITĂ", "raspuns4"=>"AEROTERMĂ", "raspuns5"=>"APARAT DE CAFEA", "raspuns6"=>"SANDWICH MAKER","punctaj1"=>"29","punctaj2"=>"23","punctaj3"=>"17","punctaj4"=>"13","punctaj5"=>"10","punctaj6"=>"8","prev"=>"intrebare3.php", "next"=>"intrebare5.php");
