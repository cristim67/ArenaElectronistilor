...
$array =  array("intrebare"=>"NUMEȘTE UN CLUB DIN BUCUREȘTI ÎN CARE ESTE POSIBIL SĂ SE AFLE PREDOMINANT STUDENȚI","raspuns1"=>"ONE", "raspuns2"=>"KULTURHOUSE", "raspuns3"=>"CONTROL", "raspuns4"=>"EL COMANDANTE", "raspuns5"=>"EXPIRAT", "raspuns6"=>"EL DICTATOR","punctaj1"=>"37","punctaj2"=>"21","punctaj3"=>"13","punctaj4"=>"11","punctaj5"=>"9","punctaj6"=>"9","prev"=>"intrebare16.php", "next"=>"intrebare18.php");
  ...
  <div class="back" style="border-radius: 100px;">
   ...
   <div style="text-align:center;  width: 860px; height:80px;
  align-items: center;
  ...
  <h1 style="text-align:center;margin-top:1rem;">~ <?php echo$array["punctaj1"]; ?> ~ </h1>
		...
		<div class="card" data-number="<?php echo$array["punctaj2"]; ?>">
          ...
          <h1 style="text-align:center;margin-top:4rem;">2</h1>
				...
				<div class="back">
          <h1 style="text-align:center;margin-top:1.5rem;zoom:0.8;"><?php echo$array["raspuns2"]; ?></h1>
