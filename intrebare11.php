...
$array =  array("intrebare"=>"NUMEȘTE O PIESĂ CARE SE ASCULTĂ LA FIECARE PARTY BY LSE?","raspuns1"=>"AM SĂ BAG DOUĂ ZIARE", "raspuns2"=>"CIOCOLATA", "raspuns3"=>"ÎN LIPSA MEA", "raspuns4"=>"FRESH", "raspuns5"=>"UNDEVA-N BALKANI", "raspuns6"=>"STUDENTA","punctaj1"=>"32","punctaj2"=>"27","punctaj3"=>"18","punctaj4"=>"12","punctaj5"=>"6","punctaj6"=>"5","prev"=>"intrebare10.php", "next"=>"intrebare12.php");
  ...
  <div class="back" style="border-radius: 100px;">
   ...
   <div style="text-align:center;  width: 660px; height:80px;
  align-items: center;
