...
$array =  array("intrebare"=>"CE FACI CÂND SUNĂ ALARMA PENTRU CURSUL DE DIMINEAȚĂ?","raspuns1"=>"AMÂNI ÎNCĂ 5 MINUTE", "raspuns2"=>"TE CULCI LA LOC", "raspuns3"=>"SUNI UN COLEG SĂ TE TREACĂ PE PREZENȚĂ", "raspuns4"=>"TE RIDICI", "raspuns5"=>"ÎNJURI", "raspuns6"=>"ARUNCI TELEFONUL","punctaj1"=>"41","punctaj2"=>"34","punctaj3"=>"10","punctaj4"=>"6","punctaj5"=>"5","punctaj6"=>"4","prev"=>"intrebare9.php", "next"=>"intrebare11.php");
...
background-color:#fff;box-shadow: rgba(60, 64, 67, 0.3) 0px 1px 2px 0px, rgba(60, 64, 67, 0.15) 0px 2px 6px 2px;   border-radius: 10px;margin:auto; ">
  ...
  <div class="card" data-number="<?php echo$array["punctaj3"]; ?>">
    <div class="flipper" >
      ...
      <div class="back">
        <h1 style="text-align:center;margin-top:1.5rem;zoom:0.8;"><?php echo$array["raspuns3"]; ?></h1>
